...
<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
  <div class="container-fluid">
    <a class="navbar-brand me-5 fw-bold fs-3 h-font " href="index.php">Mughal Hotel</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link me-1" href="rooms.php">Rooms</a>
        </li>
        <li class="nav-item">
          <a class="nav-link me-1" href="facilities.php">Facilities</a>
        </li>
        <li class="nav-item">
          <a class="nav-link me-1" href="contect.php">Contect us</a>
        </li>
        <li class="nav-item">
